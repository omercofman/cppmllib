...
namespace cppmllib
{
	...
	function<double(const vector<double>&)> gradientDescent(const vector<double>& codomain, const vector<vector<double>>& domains, vector<double>& coeff, double alpha = 0.01, size_t epochs = 20);
